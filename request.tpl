	...
	<div class="panel-holder mt-80 mb-40">
		...
		<form action="./request.php" method="POST">
			...
			<div class="form-group">
				<label class="label">Имя<input class="input film-name film-title" name="userName" type="text" placeholder="Введите ваше имя" />
				</label>
			</div> 
			<div class="form-group">
					<div class="form-group"><label class="label">Город<input class="input film-type" name="userCity" type="text" placeholder="Введите город" /></label></div>
			</div>
