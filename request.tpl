<div class="container user-content section-page">
	<div class="panel-holder mt-80 mb-40">
		<div class="title-3 mt-0">Введите логин и пароль</div>
		<form action="./set-cookie.php" method="POST">
			...
			<div class="form-group">
					<div class="form-group"><label class="label">Пароль<input class="input film-type" name="user-password" type="text" placeholder="Введите пароль" /></label></div>
			</div>
			<input class="button" type="submit" name="user-set" value="Войти" />
		</form>
